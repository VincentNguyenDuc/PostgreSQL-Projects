...
CREATE TABLE
    agency (name text PRIMARY KEY, address text);
...
CREATE TABLE
    publisher (name text PRIMARY KEY);
...
INSERT INTO
    agency
VALUES
    ('Writers Home', '123 Fake St.');

INSERT INTO
    agent
VALUES
    ('Frodo Baggins', 'Writers Home');

INSERT INTO
    agent
VALUES
    ('Bilbo Baggins', 'Writers Home');
...
VALUES
    (
        'J.T.T Rolkin',
        'This author is a prolific fantasy author',
        'Frodo Baggins'
    );
